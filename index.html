    	...
    	<div class="container">
           ...
           <!-- The slideshow -->
            <div class="carousel-inner">
    		    ...
    		    <div class="btn_main">
    			<button type="button" class="btn btn-lg"><a href="contact.php">Contact</a></button>
            </div>
        </div>
                  ...
                  <div class="widget widget_information">
                     ...
                     <ul>
                        ...
                        <li class="email clearfix">
                           ...
                           <span class="text">info@dreamjourney-safaris.com</span>
                        </li>
                     </ul>
                  </div>
                  <div class="widget widget_socials">
                     <div class="socials">
                        <a target="_blank" href="mailto:info@dreamjourney-safaris.com"><i class="fa fa-envelope"></i></a>
